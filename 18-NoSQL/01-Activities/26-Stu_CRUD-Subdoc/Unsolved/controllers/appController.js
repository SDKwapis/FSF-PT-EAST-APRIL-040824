...
module.exports = {
  ...
  //updates the info in the application model
  ...
  //it finds tha application id and removes it which results in the object being deleted
  ...
  //it adds a tag key to the object to a specific id
  ...
  // TODO: Add comments to the functionality of the addTag method
  //it searches for a specific id and updates the tag key for it
